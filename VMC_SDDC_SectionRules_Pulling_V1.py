## This program provides menu for providing section name in any case and write the rule in notepad. Users can also input for All the rules 
...
def rule_parse(rule_data,ip_groups_dict,services_dict,rule_source_name = 'ANY',rule_dest_name= 'ANY',rule_service_name='ANY'):
    ...
    for n,item in enumerate(rule_data['results']):
        try:
            ...
            with open ('c://Users/arawat/Documents/VMC_fw_Rule_Output.txt','a') as f:
        ...
        while True :
            ...
            if choice.lower()=='exit' or choice.lower()=='quit' or choice=='\n':
                ...
                for item in section_name_list:
                    ## Caling rule_data function to gather Section specific rule entries
